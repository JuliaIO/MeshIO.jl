...
The focus is on conversion between different mesh types an creation of different mesh types.
...
Similarly, if you call `mesh[Normal3{Float32}]` but the mesh doesn't have normals, it will call the functions `normals(vertices, faces, Normal3{Float32}`, which will create the normals for the mesh.
As most attributes are independant, this  enables me to easily create all kinds of conversions.
